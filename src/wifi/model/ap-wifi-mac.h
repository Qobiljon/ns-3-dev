...
namespace ns3 {
    ...
    public:
        ...
        void SendOneBeaconFromAddress (Mac48Address from_addr);
        // </editor-fold>
    ...
    private:
        ...
        // <editor-fold desc="LVAP">
        uint beacon_mac_index = 0;
        std::map<Mac48Address, uint16_t> m_sta_revmap; // reverse map for (O(1)) moving lvap from one ap to another
        // </editor-fold>
        Mac48Address my_addr;
    };
